...
//             try
//             {
//                 var result = await imageService.DeleteGalleryImage(productId, imageId);
//
//                 return result
...
//             catch (Exception ex)
//             {
//                 Log.Error(ex, "An error occurred while deleting the image {ImageId} for Product ID {ProductId}.",
//                     imageId, productId);
//                 return Results.Problem("An error occurred. Please try again later.");
//             }
